...
class TestVocabulary(unittest.TestCase):
    ...
    def test_render_call_suit_with_initial(self):
        ...
        with patch('pybridge.ui.vocabulary.config', { 'Appearance' : { 'Colours': {'Diamond': '000000000000'}} }), patch('pybridge.ui.vocabulary.STRAIN_SYMBOLS', { Strain.Diamond: 'D' }):
    ...
    def test_render_call_suit_with_symbol(self):
        ...
        call.level = Level.Two
        call.strain = Strain.Diamond
        with patch('pybridge.ui.vocabulary.config', { 'Appearance': { 'Colours': {'Diamond': '000000000000' } } }), patch('pybridge.ui.vocabulary.STRAIN_SYMBOLS', { Strain.Diamond: '\N{BLACK DIAMOND SUIT}'}) :
    ...
    def test_render_contract_undoubled(self):
        ...
        contract.bid = call
        with patch('pybridge.ui.vocabulary.config', { 'Appearance' : { 'Colours': {'Spade': '000000000000'}} }), patch('pybridge.ui.vocabulary.STRAIN_SYMBOLS', { Strain.Spade: 'S' }):
    ...
    def test_render_contract_redoubled(self):
        ...
        contract.bid = call
        with patch('pybridge.ui.vocabulary.config', { 'Appearance' : { 'Colours': {'Heart': '000000000000'}} }), patch('pybridge.ui.vocabulary.STRAIN_SYMBOLS', { Strain.Heart: 'H' }):
